...
public class FCmdRoot extends FCommand implements CommandExecutor {
    ...
    public CmdAdminFaction cmdAdminFaction = new CmdAdminFaction();
    ...
    public CmdCreateAdmin cmdCreateAdmin = new CmdCreateAdmin();
    ...
    public FCmdRoot() {
        ...
        if (FactionsPlugin.getInstance().usesBrigadierCompletions()) brigadierManager = new BrigadierManager();
        ...
        this.addSubCommand(this.cmdAdminFaction);
        ...
        addVariableCommands();
        if (FactionsPlugin.getInstance().usesBrigadierCompletions()) brigadierManager.build();
    }
    ...
    public void addVariableCommands() {
        ...
        // Pure command-registry edit (no Bukkit world/entity access); run on the global scheduler.
        FactionsPlugin.getInstance().getFactionScheduler().runGlobalLater(() -> {
    ...
    public void addSubCommand(FCommand subCommand) {
        ...
        if (FactionsPlugin.getInstance().usesBrigadierCompletions()) {
